...
extern int netmgr_wifi_sconfig(u16 channel_mask, bool user_mode);
extern int netmgr_wifi_sconfig_async(u16 channel_mask, bool user_mode);

//non-user mode
#define NETMGR_SCONFIG(mask) netmgr_wifi_sconfig_async(mask, FALSE)
//user mode
#define NETMGR_USER_SCONFIG(op) netmgr_wifi_sconfig_async(g_sta_channel_mask,TRUE)
