...
/**
 *  struct cfg_ps_wow_request  - PWR saving WOW request description
 *
 *  @ ipv4addr.
 *  @ ethtyp: ether type to filter
 */
struct cfg_ps_wow_request {
    u32      ipv4addr; /*ipaddr*/
...
//===========================================================================
 ...
 /*
    ...
    */
    ...
    SSV6XXX_HOST_CMD_SET_DEFAULT_RATEMASK                                                            ,
    SSV6XXX_HOST_CMD_SET_RC_PARAM                                                            ,
...
struct resp_evt_result {
    ...
    union {
        ...
        struct {
   	 u32                        channel_edcca_count[MAX_CHANNEL_NUM-1];
         u32                        channel_packet_count[MAX_CHANNEL_NUM-1];
   		 u8                   		result_code;//0: Success, 1:fail
        } scan_done;
        struct {
         u8                         channel;
   		 u8                   		ssid[MAX_SSID_LEN];
   		 u8                   		pwd[MAX_PASSWD_LEN];
         u8                         rand;
   		 u8                   		result_code;//0: Success, 1:fail
        } sconfig_done;
        struct {
...
#define SCAN_DONE_EVT_HEADER_sIZE   (1+(MAX_CHANNEL_NUM-1)*sizeof(u32)+(MAX_CHANNEL_NUM-1)*sizeof(u32))
