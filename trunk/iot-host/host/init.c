...
// ------------------------- rate control ---------------------------
u16 g_rc_rate_msk = RC_DEFAULT_RATE_MSK;
u16 g_rc_target_pf = RC_TARGET_PF;
u8  g_rc_arith_sft = RC_ARITH_SHIFT;
...
int ssv6xxx_dev_init(int argc, char *argv[])
{
    ...
    ssv6xxx_user_sconfig_op.UserSconfigInit=UserSconfigInit;
    ssv6xxx_user_sconfig_op.UserSconfigPaserData=UserSconfigPaserData;
    ssv6xxx_user_sconfig_op.UserSconfigSM=UserSconfigSM;
    ssv6xxx_user_sconfig_op.UserSconfigConnect=UserSconfigConnect;
    ssv6xxx_user_sconfig_op.UserSconfigDeinit=UserSconfigDeinit;
#else
    ssv6xxx_memset((void *)&ssv6xxx_user_sconfig_op,0,sizeof(ssv6xxx_user_sconfig_op));
#endif
	/**
