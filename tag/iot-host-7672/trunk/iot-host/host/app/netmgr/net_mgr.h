...
#define NET_MGR_AUTOJOIN_TRIES    3
#define NET_MGR_AUTOJOIN_INTERVAL 30 // unit second
#endif
...
typedef enum{
	WIFI_SEC_NONE,
	WIFI_SEC_WEP_40,			//5		ASCII
	WIFI_SEC_WEP_104,		//13	ASCII
...
extern void netmgr_set_netif_status(bool on);

extern int netmgr_wifi_scan_async(u16 channel_mask, char *ssids[], int ssids_count);
extern int netmgr_wifi_join_async(char *ssid, wifi_sec_type encrypt_mode, char *password);
...
extern int netmgr_wifi_join(char *ssid, wifi_sec_type encrypt_mode, char *password);
