...
s32 CmdEng_evt_ap_handle(struct cfg_host_event *pPktInfo)
{
	//ssv6xxx_result ret = SSV6XXX_SUCCESS;
...
const CmdEng_RxEvtHandler PrivateRxEvtHandler[] = 
{
	...
	CmdEng_evt_ap_handle,	//SOC_EVT_SET_BSS_PARAM_RESP
	CmdEng_evt_ap_handle,	//SOC_EVT_PS_POLL      ,
	CmdEng_evt_ap_handle,	//SOC_EVT_NULL_DATA
	NULL,					//SOC_EVT_REG_RESULT
	CmdEng_evt_ap_handle,	//SOC_EVT_DTIM_EXPIRED
};
