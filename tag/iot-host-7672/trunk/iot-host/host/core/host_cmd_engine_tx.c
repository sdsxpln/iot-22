...
#endif
#if OLDCMDENG_TRX
extern void _CmdEng_TxHdlData(void *frame ,bool bAPFrame, u32 TxFlags);
#endif
#ifdef __DUMP_TX__
...
#if OLDCMDENG_TRX
void _CmdEng_TxHdlData(void *frame ,bool bAPFrame, u32 TxFlags)
{
...
void CmdEng_TxHdlData(void *frame)
{
	_CmdEng_TxHdlData(frame , FALSE, 0);
}
#endif
