...
#if OLDCMDENG_TRX
extern void CmdEng_RxHdlData(struct cfg_host_rxpkt *pPktInfo);
extern void CmdEng_TxHdlData(struct cfg_host_txreq0 *pPktInfo);
#endif
