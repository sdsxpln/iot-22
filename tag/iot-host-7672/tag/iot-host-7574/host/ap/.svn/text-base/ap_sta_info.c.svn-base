...
//------------------------------------------------------------------------------
	...
	if (next_time) {
		os_create_timer(next_time, ap_handle_timer, pApInfo, sta, (void*)MBOX_HCMD_ENGINE);
		return;																					//---------------------------------------->Return
	}
	...
	switch (sta->timeout_next) 
	{
		case STA_NULLFUNC:
			...
			os_create_timer(AP_DISASSOC_DELAY, ap_handle_timer,
								   gDeviceInfo->APInfo, sta, (void*)MBOX_HCMD_ENGINE);
...
// 			ieee802_1x_free_station(sta);
			...
			os_create_timer(AP_DEAUTH_DELAY, ap_handle_timer, pApInfo, sta, (void*)MBOX_HCMD_ENGINE);
...
APStaInfo_st *APStaInfo_add(ApInfo_st *pApInfo, const u8 *addr)
{
	...
	os_create_timer(AP_MAX_INACTIVITY, ap_handle_timer, pApInfo, sta, (void*)MBOX_HCMD_ENGINE);
