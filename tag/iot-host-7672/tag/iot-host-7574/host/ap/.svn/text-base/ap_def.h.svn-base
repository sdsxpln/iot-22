...
#define AP_TOTAL_MAX_TX_BUFFER 	50//512
...
#define AP_STA_MAX_TX_BUFFER	16//64
...
#define AP_STA_TX_BUFFER_EXPIRE (10 * HZ)
...
#define AP_MAX_LISTEN_INTERVAL 100

//-----------------------------------
//Beacon 
#define AP_DEFAULT_BEACON_INT	(100)
#define AP_DEFAULT_DTIM_PERIOD  (4)
...
#define AP_MAX_INACTIVITY (5 * 60 * 1000) //msec
