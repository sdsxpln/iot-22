...
static inline int ap_tx_desp_queue_empty(const struct ap_tx_desp_head *list)
{
	return (const struct ap_tx_desp_head *)list->next == list;
}
...
void ap_tx_desp_queue_tail(struct ap_tx_desp_head *list, struct ap_tx_desp *new_ap_tx_desp);
