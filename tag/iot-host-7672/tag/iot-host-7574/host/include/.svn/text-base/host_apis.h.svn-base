 ...
 */
 struct cfg_host_txreq0 {	
    ...
    u32               ht:1;
    u32               use_4addr:1;
    u32               RSVD0:3;			//AP mode use one bit to know if this packet is buffered frame(Power saving) AP_PS_FRAME
	u32				  bc_queue:1;
    u32               security:1;
    u32               more_data:1;
    u32               sub_type:2;
...
H_APIs ssv6xxx_result ssv6xxx_wifi_station(struct sta_setting *sta_station);
