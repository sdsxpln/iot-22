...
// is NOT inited yet.
//
#define 	sys_init_prnf		print_string
...
#define LOG_PRINTF_LM(l, m, fmt, ...)	(((l) == LOG_LEVEL_FATAL) ? ssv6xxx_fatal(m, __FILE__, __LINE__, fmt, ##__VA_ARGS__) : ssv6xxx_printf((l), (m), __FILE__, __LINE__, fmt, ##__VA_ARGS__))
