...
static s32 send_cfg_cmd(HDR_HostCmd *host_cmd, s32 len, void *args)
{
    ...
    retval = snd_func((s8 *)host_cmd, host_cmd->len);
    return retval;
}
...
#endif
static s32 set_sta_bssid(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_sta_mac(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_sta_opmode(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_wsid_entry(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_enable_disable(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
...
static s32 set_sta_qos(void *args, s32 argc, s8 *argv[])
{
    u8 *str[] = { "disable", "enable" };
    struct cfg_host_cmd *host_cmd;
    u32 i, len=sizeof(u32);
...
static s32 set_pkt_offset(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_mcfilter(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
...
static s32 show_mcfilter(void *addr, s32 argc, s8 *argv[])
{
    /*s32 entry;
	gmfilter mf_addr;
...
static s32 set_tx_eth_trap(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_rx_eth_trap(void *args, s32 argc, s8 *argv[])
{
    s32 index, len=sizeof(s32)+sizeof(u32);
    HDR_HostCmd *host_cmd;
    u32 eth_type;
...
static s32 show_eth_trap(void *addr, s32 argc, s8 *argv[])
{
    s32 entry;
...
static s32 set_dup_filter(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
    u8 *str[] = { "disable", "enable" };
...
static s32 set_promis_mode(void *args, s32 argc, s8 *argv[])
{
    u8 *str[] = { "disable", "enable" };
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
...
static s32 set_pair_security(void *args, s32 argc, s8 *argv[])
{
    struct wsimp_cfg_cmd_tbl *cfg_entry=args;
    struct cfg_host_cmd *host_cmd;
    s32 (*snd_func)(s8 *, s32); 
    ...
    for(i=0; i<sizeof(str)/sizeof(u8 *); i++) {
        if (strcmp(argv[1], str[i]) == 0) {
	        ...
	        return snd_func((s8 *)host_cmd, host_cmd->len);
        }
    }
    return -1;
}
...
static s32 set_group_security(void *args, s32 argc, s8 *argv[])
{
    struct wsimp_cfg_cmd_tbl *cfg_entry=args;
    struct cfg_host_cmd *host_cmd;
    s32 (*snd_func)(s8 *, s32); 
...
static s32 set_pair_entry(void *args, s32 argc, s8 *argv[])
{
    struct wsimp_cfg_cmd_tbl *cfg_entry=args;
    struct cfg_host_cmd *host_cmd;
    s32 (*snd_func)(s8 *, s32);
...
static s32 set_group_entry(void *args, s32 argc, s8 *argv[])
{
    struct wsimp_cfg_cmd_tbl *cfg_entry=args;
    struct cfg_host_cmd *host_cmd;
    s32 (*snd_func)(s8 *, s32);
...
static s32 set_tx_info_security(void *addr, s32 argc, s8 *argv[])
{
#if (CONFIG_HOST_PLATFORM == 1 )	
	u8 *str[] = { "disable", "enable" };
	s32 i;
...
static s32 set_ht_mode(void *args, s32 argc, s8 *argv[])
{
...
static s32 set_sta_nav(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_hdr_strip_off(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
    u8 *str[] = { "disable", "enable" };
...
static s32 set_hci_rx2host(void *args, s32 argc, s8 *argv[])
{
    u8 *str[] = { "disable", "enable" };
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
...
static s32 set_reason_trap(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
...
static s32 set_seqno_ctrl(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static u32 _gen_flow_cmd_reason(s32 argc, s8 *argv[]) 
{
...
static u32 _gen_flow_cmd(s32 argc, s8 *argv[])
{
...
static s32 set_tx_flow_data(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32)+sizeof(u32);
...
static s32 set_tx_flow_mgmt(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32)+sizeof(u32);
...
static s32 set_tx_flow_ctrl(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_rx_flow_data(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32)+sizeof(u32);
...
static s32 set_rx_flow_mgmt(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32)+sizeof(u32);
...
static s32 set_rx_flow_ctrl(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32)+sizeof(u32);
...
static s32 set_wmm_param(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_txop_dc_by_frame(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_tx_queue_halt(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_wmm_random(void *args, s32 argc, s8 *argv[])
{
#if 0
	s32 i, cnt=0;
	struct cfg_host_cmd *host_cmd;
...
static s32 set_tx_packet_cnt(void *args, s32 argc, s8 *argv[])
{
	...
	{		
	    ...
	    return snd_func((s8 *)host_cmd, len);    
	}
}



static s32 set_mac_mode(void *args, s32 argc, s8 *argv[])
{
    s8 *mstr[] = { "normal", "mac-loopback", "mac-to-mac", "phy-loopback" };
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_sifs(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_difs(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_eifs(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_mgmt_txqid(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_nonqos_txqid(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_auto_seqno(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
    u8 *str[] = { "disable", "enable" };
...
static s32 set_rx2host_fmt(void *args, s32 argc, s8 *argv[])
{	 

	struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
    s8 *str[] = { "disable", "enable" };
...
static s32 set_tx_rx_info_size(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
static s32 set_erp_protect(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 i, len=sizeof(u32);
    s8 *str[] = { "disable", "rts/cts", "cts-to-self" };
...
static s32 set_decision_table(void *args, s32 argc, s8 *argv[])
{
#if 0
    struct cfg_host_cmd *host_cmd;
    ...
    pos = (s8 *)sg_host_cmd + sg_host_cmd->len;
    for(i=0; i<argc; i++) {
        //LOG_PRINTF("  [%d]: ==> %s\n", i, argv[i]);
...
static s32 set_frag_threshold(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
...
#if 0
static s32 init_phy_table(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
...
/*static s32 set_mib(void *args, s32 argc, s8 *argv[])
{
	struct cfg_host_cmd *host_cmd;
...
static s32 set_phy_info(void *args, s32 argc, s8 *argv[])
{
    s8 *pos;
    s32 i, res;
...
static s32 set_tx_rx_check(void *args, s32 argc, s8 *argv[])
{	 
...
static s32 show_all(void *args, s32 argc, s8 *argv[])
{
	struct cfg_host_cmd *host_cmd;
    s32	len=sizeof(u32);
...
static s32 set_multi_mac_mode(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
    u32 mode = 0;
...
static s32 set_rx_tods_mask(void *args, s32 argc, s8 *argv[])
{
    struct cfg_host_cmd *host_cmd;
    s32 len=sizeof(u32);
    u32 mask = 0;
...
s32 wsimp_cfg_regs(void *args, s32 argc, s8 *argv[])
{    
    struct wsimp_cfg_cmd_tbl *cmdtbl;
    s32 i, sargc, res;
    s8 *sargv[100], buffer[1024];
